...
- 分类标识：`ICBC`
- 分类显示名：`工商银行`
- 文件：`rule/Clash/ICBC/ICBC.yaml`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Clash/ICBC/ICBC.yaml>
- 已省略的不兼容类型：无
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Clash/ICBC/ICBC.yaml>
