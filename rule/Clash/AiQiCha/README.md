...
- 分类标识：`AiQiCha`
- 分类显示名：`爱企查`
- 文件：`rule/Clash/AiQiCha/AiQiCha.yaml`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Clash/AiQiCha/AiQiCha.yaml>
- 已省略的不兼容类型：无
...
- [v2fly geosite aiqicha](https://github.com/v2fly/domain-list-community/blob/master/data/aiqicha)
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Clash/AiQiCha/AiQiCha.yaml>
