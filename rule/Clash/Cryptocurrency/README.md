...
Cryptocurrency 相关支付、电商、银行、证券或交易服务规则。
...
- 当前客户端：`Clash`
- 分类标识：`Cryptocurrency`
- 分类显示名：`Cryptocurrency`
- 文件：`rule/Clash/Cryptocurrency/Cryptocurrency.yaml`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Clash/Cryptocurrency/Cryptocurrency.yaml>
- 已省略的不兼容类型：无
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Clash/Cryptocurrency/Cryptocurrency.yaml>
