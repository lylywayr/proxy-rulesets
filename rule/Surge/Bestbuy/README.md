...
- 分类标识：`Bestbuy`
- 分类显示名：`百思买`
- 文件：`rule/Surge/Bestbuy/Bestbuy.list`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/Bestbuy/Bestbuy.list>
- 已省略的不兼容类型：无
...
- [v2fly geosite bestbuy](https://github.com/v2fly/domain-list-community/blob/master/data/bestbuy)
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/Bestbuy/Bestbuy.list>
