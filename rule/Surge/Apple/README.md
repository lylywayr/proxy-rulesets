...
- 分类标识：`Apple`
- 分类显示名：`苹果`
- 文件：`rule/Surge/Apple/Apple.list`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/Apple/Apple.list>
- 已省略的不兼容类型：无
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/Apple/Apple.list>
