...
- 分类标识：`AppleTV`
- 分类显示名：`Apple TV+`
- 文件：`rule/Surge/AppleTV/AppleTV.list`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/AppleTV/AppleTV.list>
- 已省略的不兼容类型：无
...
- [v2fly geosite apple-tvplus](https://github.com/v2fly/domain-list-community/blob/master/data/apple-tvplus)
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/AppleTV/AppleTV.list>
