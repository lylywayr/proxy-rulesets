...
ProxyLite 相关代理、直连、测速、隐私或基础分流规则。
...
- 分类标识：`ProxyLite`
- 分类显示名：`ProxyLite`
- 文件：`rule/Surge/ProxyLite/ProxyLite.list`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/ProxyLite/ProxyLite.list>
- 已省略的不兼容类型：无
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/ProxyLite/ProxyLite.list>
