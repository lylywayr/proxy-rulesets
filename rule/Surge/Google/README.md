...
- 分类标识：`Google`
- 分类显示名：`谷歌`
- 文件：`rule/Surge/Google/Google.list`
- 当前直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/Google/Google.list>
- 已省略的不兼容类型：无
...
- Current raw URL: <https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Surge/Google/Google.list>
