...
聚合 Cloudflare 相关服务、域名、关键词与网络目标，面向 云与网络 场景下的规则分流、客户端引用与统一维护。
...
- 规则格式：`YAML Rule Set`
- 文件：`rule/Egern/Cloudflare/Cloudflare.yaml`
- 直链：<https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Egern/Cloudflare/Cloudflare.yaml>
- 已省略的不兼容类型：无

### 客户端入口

- [Egern 一键预填](egern:/rules/new?type=rule_set&match=https%3A%2F%2Fraw.githubusercontent.com%2Flylywayr%2Fproxy-rulesets%2Fmain%2Frule%2FEgern%2FCloudflare%2FCloudflare.yaml): 在 Egern 中预填 rule_set 规则，策略可在跳转后自行选择。
- [Egern 新建配置](egern:/profiles/new?name=Cloudflare&url=https%3A%2F%2Fraw.githubusercontent.com%2Flylywayr%2Fproxy-rulesets%2Fmain%2Frule%2FEgern%2FCloudflare%2FCloudflare.yaml): 按官方 URL Scheme 预填配置地址。
...
Aggregated rules for Cloudflare, covering related domains, keywords, and network targets for network routing workflows.
