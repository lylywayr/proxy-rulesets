...
- 客户端: `Egern`
- 文件: `rule/Egern/Google/Google.yaml`
- 直链: `https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Egern/Google/Google.yaml`
- 已省略的不兼容类型: PROCESS-NAME=7
...
- Client: `Egern`
- File: `rule/Egern/Google/Google.yaml`
- Raw URL: `https://raw.githubusercontent.com/lylywayr/proxy-rulesets/main/rule/Egern/Google/Google.yaml`
- Omitted unsupported types: `PROCESS-NAME=7`
